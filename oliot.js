const autot = [{id:1, merkki: "Toyota", vuosimalli: 2006, hinta: 4500}, {id:2, merkki: "BMW", vuosimalli: 1986, hinta: 3500}, {id:3, merkki: "Lada", vuosimalli: 1991, hinta:500}]
var hakusana = ""
...
standard_input.on('data', function (data) {
    if (data === 'exit\r\n'){
    console.log("Kiitos ja näkemiiin")
    process.exit()
}
else{
    hakusana =data.trim()
